  ...
  return (
    <section className="relative  h-[28rem] sm:h-[36rem] md:h-[33rem] lg:h-[50rem] m-2 md:m-5 rounded-3xl flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: `url(${"https://res.cloudinary.com/dkzvu1c4j/image/upload/v1754294754/avees_team_ossayv.jpg"})`,
      ...
      <div className="absolute inset-0 bg-black/20 " />
        ...
        >
          ...
          Build The Future
            ...
            >
   Join our network of successful partners. Explore franchise, distribution, 
          and export opportunities designed for growth.
                      </motion.p>
