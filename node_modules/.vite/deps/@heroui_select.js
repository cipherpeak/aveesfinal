...
import "./chunk-VTGC4MY7.js";
import "./chunk-DLNCMMPT.js";
import {
  useAriaButton
...
function $7af3f5b51489e0b5$export$253fe78d46329472(props) {
  ...
  let defaultSelectedKeys = (0, import_react.useMemo)(() => $7af3f5b51489e0b5$var$convertSelection(props.defaultSelectedKeys, new (0, $e40ea825a81a3709$export$52baac22726c72bf)()), [
...
function $e72dd72e1c76a225$export$2f645645f7bca764(props) {
  ...
  let factory = (0, import_react2.useCallback)((nodes) => filter ? new (0, $a02d57049d202695$export$d085fb9e920b5ca7)(filter(nodes)) : new (0, $a02d57049d202695$export$d085fb9e920b5ca7)(nodes), [
    filter
  ]);
...
function useMultiSelectListState(props) {
  ...
  const missingKeys = (0, import_react4.useMemo)(() => {
...
function $a28c903ee9ad8dc5$export$79fefeb1c2091ac3(props) {
  ...
  let [focusStrategy, setFocusStrategy] = (0, import_react5.useState)(null);
  let [expandedKeysStack, setExpandedKeysStack] = (0, import_react5.useState)([]);
  let closeAll = () => {
...
function useMultiSelectState({
  ...
  const [focusStrategy, setFocusStrategy] = (0, import_react7.useState)(null);
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
  ...
  let shouldVirtualFocusFirst = (0, import_react9.useRef)(false);
  ...
  const didAutoFocusRef = (0, import_react9.useRef)(false);
...
function useMultiSelect(props, state, ref) {
  ...
  const delegate = (0, import_react15.useMemo)(
...
function useSelect(originalProps) {
  ...
  const handleClear = (0, import_react16.useCallback)(() => {
    var _a2;
  ...
  const getTriggerProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ref: triggerRef,
        "data-slot": "trigger",
  ...
  const getHiddenSelectProps = (0, import_react16.useCallback)(
    (props2 = {}) => ({
      state,
      triggerRef,
      selectRef: domRef,
  ...
  const getValueProps = (0, import_react16.useCallback)(
    (props2 = {}) => ({
      "data-slot": "value",
  ...
  const getListboxWrapperProps = (0, import_react16.useCallback)(
    (props2 = {}) => ({
  ...
  const getPopoverProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      var _a2, _b2;
  ...
  const getSelectorIconProps = (0, import_react16.useCallback)(
    () => ({
  ...
  const getInnerWrapperProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getHelperWrapperProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getDescriptionProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
        ...descriptionProps,
  ...
  const getMainWrapperProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getEndWrapperProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getEndContentProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getErrorMessageProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
        ...errorMessageProps,
  ...
  const getSpinnerProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        "aria-hidden": dataAttr(true),
        "data-slot": "spinner",
  ...
  const getClearButtonProps = (0, import_react16.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
        type: "button",
...
var useLayoutEffect = typeof document !== "undefined" ? import_react17.default.useLayoutEffect : () => {
};
...
function HiddenSelect(props) {
  ...
  if (state.collection.size <= 300) {
    return (0, import_jsx_runtime.jsx)("div", { ...containerProps, "data-testid": "hidden-select-container", children: (0, import_jsx_runtime.jsxs)("label", { children: [
      label,
      (0, import_jsx_runtime.jsxs)("select", { ...selectProps, ref: selectRef, children: [
        (0, import_jsx_runtime.jsx)("option", {}),
        [...state.collection.getKeys()].map((key) => {
          let item = state.collection.getItem(key);
          if ((item == null ? void 0 : item.type) === "item") {
            return (0, import_jsx_runtime.jsx)("option", { value: item.key, children: item.textValue }, item.key);
          }
        })
      ] })
    ] }) });
...
function useListbox(props) {
  ...
  const slots = (0, import_react18.useMemo)(() => menu(), []);
  const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
...
function useListboxItem(originalProps) {
  ...
  const getSelectedIconProps = (0, import_react19.useCallback)(
    (props2 = {}) => {
      return {
        "aria-hidden": dataAttr(true),
        "data-disabled": dataAttr(isDisabled),
...
var ListboxItem = (props) => {
  ...
  const selectedContent = (0, import_react20.useMemo)(() => {
    const defaultIcon = (0, import_jsx_runtime3.jsx)(ListboxSelectedIcon, { disableAnimation, isSelected });
  ...
  return (0, import_jsx_runtime3.jsxs)(Component, { ...getItemProps(), children: [
    startContent,
    description ? (0, import_jsx_runtime3.jsxs)("div", { ...getWrapperProps(), children: [
      (0, import_jsx_runtime3.jsx)("span", { ...getLabelProps(), children: rendered }),
      (0, import_jsx_runtime3.jsx)("span", { ...getDescriptionProps(), children: description })
    ] }) : (0, import_jsx_runtime3.jsx)("span", { ...getLabelProps(), children: rendered }),
    isSelectable && !hideSelectedIcon && (0, import_jsx_runtime3.jsx)("span", { ...getSelectedIconProps(), children: selectedContent }),
    endContent
  ] });
};
...
function useDivider(props) {
  ...
  const getDividerProps = (0, import_react21.useCallback)(
    (props2 = {}) => ({
      className: styles,
      role: "separator",
...
var Divider = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Component, { ref, ...getDividerProps() });
});
...
var ListboxSection = forwardRef(
  ({
    ...
    const slots = (0, import_react22.useMemo)(() => menuSection(), []);
    const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
    ...
    return (0, import_jsx_runtime5.jsxs)(
      Component,
      {
        ...
        className: slots.base({ class: baseStyles }),
        children: [
          item.rendered && (0, import_jsx_runtime5.jsx)(
            "span",
            {
              ...headingProps,
            ...
            "ul",
            {
              ...
              children: [
                [...item.childNodes].map((node) => {
                  ...
                  let listboxItem = (0, import_jsx_runtime5.jsx)(
                ...
                showDivider && (0, import_jsx_runtime5.jsx)(
                  divider_default,
                  {
                    as: "li",
...
function useDataScrollOverflow(props = {}) {
  ...
  const visibleRef = (0, import_react24.useRef)(visibility);
...
var VirtualizedListbox = (props) => {
  ...
  const itemSizes = (0, import_react23.useMemo)(
  ...
  const renderRow = (virtualItem) => {
    ...
    let listboxItem = (0, import_jsx_runtime6.jsx)(
      listbox_item_default,
      {
        ...itemProps,
  ...
  const [scrollState, setScrollState] = (0, import_react23.useState)({
    isTop: false,
    isBottom: true,
    isMiddle: false
  });
  const content = (0, import_jsx_runtime6.jsxs)(
    Component,
    {
      ...getListProps(),
      ...
      children: [
        !state.collection.size && !hideEmptyContent && (0, import_jsx_runtime6.jsx)("li", { children: (0, import_jsx_runtime6.jsx)("div", { ...getEmptyContentProps() }) }),
        (0, import_jsx_runtime6.jsx)(
          "div",
          {
            ...
            children: listHeight > 0 && itemHeight > 0 && (0, import_jsx_runtime6.jsx)(
              "div",
              {
                style: {
  ...
  return (0, import_jsx_runtime6.jsxs)("div", { ...getBaseProps(), children: [
    topContent,
    content,
    bottomContent
  ] });
...
var Listbox = forwardRef(function Listbox2(props, ref) {
  ...
  if (isVirtualized) {
    return (0, import_jsx_runtime7.jsx)(virtualized_listbox_default, { ...props, ...useListboxProps });
  }
  const content = (0, import_jsx_runtime7.jsxs)(Component, { ...getListProps(), children: [
    !state.collection.size && !hideEmptyContent && (0, import_jsx_runtime7.jsx)("li", { children: (0, import_jsx_runtime7.jsx)("div", { ...getEmptyContentProps() }) }),
    [...state.collection].map((item) => {
      ...
      if (item.type === "section") {
        return (0, import_jsx_runtime7.jsx)(listbox_section_default, { ...itemProps, itemClasses }, item.key);
      }
      let listboxItem = (0, import_jsx_runtime7.jsx)(
        listbox_item_default,
        {
          ...itemProps,
  ...
  return (0, import_jsx_runtime7.jsxs)("div", { ...getBaseProps(), children: [
    topContent,
    content,
    bottomContent
  ] });
...
function useDataScrollOverflow2(props = {}) {
  ...
  const visibleRef = (0, import_react26.useRef)(visibility);
...
function useScrollShadow2(originalProps) {
  ...
  const styles = (0, import_react27.useMemo)(
    () => scrollShadow({
      ...variantProps,
      className
    }),
...
var ScrollShadow = forwardRef((props, ref) => {
  const { Component, children, getBaseProps } = useScrollShadow2({ ...props, ref });
  return (0, import_jsx_runtime8.jsx)(Component, { ...getBaseProps(), children });
});
...
var Select = forwardRef(function Select2(props, ref) {
  ...
  const {
    ...
    isLoading,
    triggerRef,
    selectorIcon = (0, import_jsx_runtime9.jsx)(ChevronDownIcon, {}),
    description,
    errorMessage,
    isInvalid,
    startContent,
  ...
  const labelContent = label ? (0, import_jsx_runtime9.jsx)("label", { ...getLabelProps(), children: label }) : null;
  const clonedIcon = (0, import_react29.cloneElement)(selectorIcon, getSelectorIconProps());
  const clearButton = (0, import_react28.useMemo)(() => {
    var _a2;
    if (isClearable && ((_a2 = state.selectedItems) == null ? void 0 : _a2.length)) {
      return (0, import_jsx_runtime9.jsx)("span", { ...getClearButtonProps(), children: (0, import_jsx_runtime9.jsx)(CloseFilledIcon, {}) });
    }
    return null;
  }, [isClearable, getClearButtonProps, (_a = state.selectedItems) == null ? void 0 : _a.length]);
  const end = (0, import_react28.useMemo)(() => {
    if (clearButton) {
      return (0, import_jsx_runtime9.jsxs)("div", { ...getEndWrapperProps(), children: [
        clearButton,
        endContent && (0, import_jsx_runtime9.jsx)("span", { ...getEndContentProps(), children: endContent })
      ] });
    }
    return endContent && (0, import_jsx_runtime9.jsx)("span", { ...getEndContentProps(), children: endContent });
  }, [clearButton, endContent, getEndWrapperProps, getEndContentProps]);
  const helperWrapper = (0, import_react28.useMemo)(() => {
    const shouldShowError = isInvalid && errorMessage;
    const hasContent = shouldShowError || description;
    if (!hasHelper || !hasContent) return null;
    return (0, import_jsx_runtime9.jsx)("div", { ...getHelperWrapperProps(), children: shouldShowError ? (0, import_jsx_runtime9.jsx)("div", { ...getErrorMessageProps(), children: errorMessage }) : (0, import_jsx_runtime9.jsx)("div", { ...getDescriptionProps(), children: description }) });
  }, [
    hasHelper,
    isInvalid,
    errorMessage,
  ...
  const renderSelectedItem = (0, import_react28.useMemo)(() => {
    var _a2;
  ...
  const renderIndicator = (0, import_react28.useMemo)(() => {
    if (isLoading) {
      return (0, import_jsx_runtime9.jsx)(spinner_default, { ...getSpinnerProps() });
    }
    return clonedIcon;
  }, [isLoading, clonedIcon, getSpinnerProps]);
  const popoverContent = (0, import_react28.useMemo)(
    () => state.isOpen ? (0, import_jsx_runtime9.jsx)(free_solo_popover_default, { ...getPopoverProps(), children: (0, import_jsx_runtime9.jsx)(scroll_shadow_default, { ...getListboxWrapperProps(), children: (0, import_jsx_runtime9.jsx)(listbox_default, { ...getListboxProps() }) }) }) : null,
  ...
  return (0, import_jsx_runtime9.jsxs)("div", { ...getBaseProps(), children: [
    (0, import_jsx_runtime9.jsx)(HiddenSelect, { ...getHiddenSelectProps() }),
    shouldLabelBeOutside ? labelContent : null,
    (0, import_jsx_runtime9.jsxs)("div", { ...getMainWrapperProps(), children: [
      (0, import_jsx_runtime9.jsxs)(Component, { ...getTriggerProps(), children: [
        !shouldLabelBeOutside ? labelContent : null,
        (0, import_jsx_runtime9.jsxs)("div", { ...getInnerWrapperProps(), children: [
          startContent,
          (0, import_jsx_runtime9.jsx)("span", { ...getValueProps(), children: renderSelectedItem }),
          endContent && state.selectedItems && (0, import_jsx_runtime9.jsx)($5c3e21d68f1c4674$export$439d29a4e110a164, { elementType: "span", children: "," }),
          end
        ] }),
        renderIndicator
      ] }),
    ...
    disableAnimation ? popoverContent : (0, import_jsx_runtime9.jsx)(AnimatePresence, { children: popoverContent })
  ] });
});
...
//# sourceMappingURL=@heroui_select.js.map
